<flux:modal wire:model="showDeleteModal"
    ...
    <div class="flex items-center justify-between">
        <flux:heading size="lg" class="text-danger-800!">{{ __('Eliminar producto') }}</flux:heading>
    </div>
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <div class="mt-2 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">{{ $selectedProduct->description ?? 'Sin descripción' }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 pt-4">
        ...
        <flux:button variant="danger" class="text-background! w-full sm:w-auto" wire:click="deleteProduct">
            {{ __('Eliminar producto') }}</flux:button>
    </div>
</flux:modal>
