<flux:modal wire:model="showUpdateModal"
    ...
    <div class="flex items-center justify-between">
        <flux:heading size="lg" class="font-semibold text-primary-600!">{{ __('Actualizar producto') }}
        </flux:heading>
    </div>
        ...
        <form wire:submit.prevent="updateProduct">
            <div class="bg-gray-50 p-4 rounded-md">
                ...
                <div class="flex justify-end mt-4">
                    <flux:button wire:click="updateProduct" variant="primary" wire:loading.attr="disabled"
                        wire:target="updateProduct" class="w-full sm:w-auto">
                        <span wire:loading.remove wire:target="updateProduct">{{ __('Actualizar') }}</span>
                        <span wire:loading wire:target="updateProduct">Actualizando...</span>
                    </flux:button>
                </div>
            </div>
        </form>
