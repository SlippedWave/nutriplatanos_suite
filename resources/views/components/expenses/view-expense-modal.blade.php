<flux:modal wire:model="showViewExpenseModal" class="space-y-4 border-0 bg-background! w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-xl p-3 mx-4">
    ...
    <div class="flex justify-end gap-2 sm:gap-3 pt-4">
       <flux:button wire:click="closeModals" variant="primary" class="text-sm sm:text-base">
          {{ __('Cerrar') }}
       </flux:button>
    </div>
</flux:modal>